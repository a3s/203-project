...
public class GraphTest {
	...
	public void testEdgesOfSTUDENT() {
		Set<Road> roads = graph.edgesOf(town[10]);
		ArrayList<String> roadArrayList = new ArrayList<String>();
		for(Road road : roads)
			roadArrayList.add(road.getName());
		Collections.sort(roadArrayList);
		assertEquals("Road_10", roadArrayList.get(0));
		assertEquals("Road_11", roadArrayList.get(1));
		assertEquals("Road_8", roadArrayList.get(2));
		assertEquals("Road_9", roadArrayList.get(3));
	}
	...
	public void testRemoveEdgeSTUDENT() {
		...
		graph.removeEdge(town[8], town[4], 3, "Road_6");
